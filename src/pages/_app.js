...
// ** Yup Locale Import
import 'src/@core/components/locale-yup/index';

// ** React Perfect Scrollbar Style Imports
import 'react-perfect-scrollbar/dist/css/styles.css';
import 'src/@core/components/iconify-bundle/icons-bundle-react';
...
const App = props => {
    ...
    return (
        ...
        <CacheProvider value={emotionCache}>
            <Head>
            <title>{`${themeConfig.templateName} - Organização de empresas`}</title>
            <meta name='description' content={`${themeConfig.templateName} – Gerir todos os projetos da sua empresa`} />
