...
const AutocompleteComponent = ({ hidden, settings }) => {
  ...
  // Lidar com evento de clique em um item de lista no resultado da pesquisa
  ...
  // Lidar com eventos de tecla ESC e teclas de atalho
  const handleKeydown = useCallback(
    event => {
      // ** Teclas de atalho para abrir a caixa de pesquisa (Ctrl + /)
  ...
  // Lidar com eventos de teclas de atalho
  const handleKeyUp = useCallback(
    event => {
      // ** Tecla ESC para fechar a caixa de pesquisa
                ...
                renderOption={(props, option) => {
                  return searchValue.length ? (
                    <ListItem
                      {...props}
                      key={option.title}
                      className={`sugestão ${props.className}`}
